...
const SabpaisaSdk: FunctionComponent<SabPaisaSdkProps> = (
  props: SabPaisaSdkProps
) => {
    ...
    <div className='App'>
      <header className='App-header'>
        ...
        >
          ...
          <button id='submitSabPaisaBtn' className='ui button' type='submit'>
            Submit
          </button>
        </form> */}
        {/* //If user wants to redirect to PG without checkout form pass the
        uniqid() in clientTxnId other wise no need to pass anything. //If user
        wants to test on production then env={'prod'}
